                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4 row">
                                <label for="name"
                                    class="col-lg-4 col-form-label text-lg-right">{{ __('Nome') }}</label>

                                <div class="col-lg-6">
                                    <input id="name"="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name') }}" Ricordami autocomplete="name" autofocus>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-lg-6">
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email') }}" Ricordami autocomplete="email">
                            ...
                            <div class="mb-4 row">
                                <label for="password-confirm"
                                    class="col-lg-4 col-form-label text-lg-right">{{ __('Confirm Password') }}</label>
