...
@section('content')
    @if ($screenshots)
        ...
        <h1>
            Aggiungi screenshots a
            <span class="text-primary">{{ $videogame->name }}</span>
        </h1>
        ...
        <form
            ...
            <div class="form-control mb-3 d-flex flex-column p-3">
                ...
                <label for="name" id="input-info">
                    Tipi di file consentiti: jpeg,png,jpg,webp | Dimensione Max.
                    per immagine: 2 MB |
                    <span class="fw-bold text-warning">
                        Max. {{ $remainingCount }} {{ $label }}
                    </span>
                </label>
                ...
                @if (count($screenshots) > 0)
                    <div class="mt-3 fw-bold">
                        Screenshot attuali
                        <span class="fw-bold">{{ $screenshotsCount }}</span>
                        :
                    </div>
                ...
                <x-new-screenshot-overlay>
                    ...
                    <x-slot:img>
                        <img src="" alt="" id="new-screenshot-overlay-img" class="rounded shadow-sm" />
                    </x-slot>
                    <x-slot:index></x-slot>
                </x-new-screenshot-overlay>
            ...
            <div>
                ...
                <button type="button" onclick="clearScreenshots()" class="btn btn-danger" id="clear-all">
                    Svuota tutto
                </button>
            </div>
