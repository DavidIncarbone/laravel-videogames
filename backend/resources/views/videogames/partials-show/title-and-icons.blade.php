...
<div id="icons"
    ...
    <a class="text-decoration-none text-dark fs-2" href="{{ route('admin.videogames.edit', $videogame) }}">
        <i id="pencil" class="bi bi-pencil"></i>
    </a>
    <button type="button" class="text-decoration-none text-dark btn p-0 fs-2" data-bs-toggle="modal"
