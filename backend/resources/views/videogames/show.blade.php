...
@section("content")
    <div
        class="container-fluid px-3 px-lg-5 py-4 mb-3"
                ...
                <div class="col-12 col-lg-6">
                    <div class="w-100 mb-3" style="height: 50vh">
                        <img
                            ...
                            alt="{{ Str::limit($videogame->name, 20) . "-cover" }}"
                            class="rounded shadow-sm current-cover"
                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
                        <div style="width: 50px; height: 50px">
                            <img
                                src="{{ asset("storage/" . $videogame->pegi->logo) }}"
    ...
    <x-modal>
        ...
        <x-slot:deleteBtn>
            <form
                id="deleteVideogameForm"
                action="{{ route("admin.videogames.show.destroy", $videogame->slug) }}"
                method="POST"
            >
                @csrf
                @method("DELETE")
