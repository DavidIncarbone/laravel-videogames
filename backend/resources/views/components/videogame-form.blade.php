...
>
    ...
    <div class="form-control mb-3 d-flex flex-column p-3">
        ...
        <div class="d-flex align-items-center position-relative">
            ...
            <input
                ...
                class="form-control pr-5 bg-white ps-5 pe-5"
        ...
        <div class="d-flex gap-3 justify-content-between">
            ...
            <div class="form-check d-flex align-items-center gap-1 mb-3">
                <div
                    ...
                    onclick="selectAll('console_ids\\[\\]')"
                >
                    Seleziona tutti
                </div>
                <div
                    class="btn btn-danger"
                    onclick="resetAll('console_ids\\[\\]')"
                >
                    Reset
                </div>
            </div>
    ...
    <div class="form-control mb-3 p-3">
        <div class="d-flex gap-3 justify-content-between mb-3">
            ...
            <div class="form-check d-flex align-items-center gap-1">
                <div
                    class="btn btn-secondary"
                    onclick="selectAll('genre_ids\\[\\]')"
                >
                    Seleziona tutti
                </div>
                <div
                    class="btn btn-danger"
                    onclick="resetAll('genre_ids\\[\\]')"
                >
                    Reset
                </div>
            </div>
    ...
    <div
        class="form-control mb-3 d-flex flex-column flex-lg-row gap-4 gap-lg-3 p-3 pb-5 pb-lg-3"
    >
        {{-- YEAR OF PUBLICATION --}}
            ...
            <div class="d-flex flex-column position-relative">
                <div>
                    ...
                    <input
                        ...
                        value="{{ old("year_of_publication", $year_of_publication) }}"
    ...
    <div class="form-control mb-3 d-flex flex-column p-3">
        ...
        <div class="d-flex align-items-center position-relative">
            <textarea
                ...
                id="description"
                width="100%"
                placeholder="Inserisci quì la descrizione del videogioco"
                oninput="toggleClearButton('description')"
                class="form-control pr-5 pe-5 bg-white"
            >
{{ $description }}</textarea
            >
            <span
                id="clear-btn-description"
                class="position-absolute end-0 pe-3"
                style="cursor: pointer; display: none"
