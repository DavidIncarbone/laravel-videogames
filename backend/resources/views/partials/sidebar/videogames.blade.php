...
<li class="d-flex flex-column">
    ...
    >
        ...
        @auth
            <i
                class="bi {{ request()->is("admin/videogames*") ? "bi-caret-down-fill" : "bi-caret-right-fill" }}"
            ></i>
        @endauth
    ...
    @auth
        <div
            class="collapse {{ request()->is("admin/videogames*") ? "show" : "" }}"
        ...
        >
            <div class="ps-3">
                <ul class="nav flex-column small">
                    <li>
                        <a
                            href="{{ route("admin.videogames.index") }}"
                    ...
                    <li>
                        <a
                            href="{{ route("admin.videogames.create") }}"
