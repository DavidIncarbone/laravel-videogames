...
<li>
    ...
    >
        ...
        @auth
            <i
                class="bi {{ request()->is("admin/consoles*") ? "bi-caret-down-fill" : "bi-caret-right-fill" }}"
            ></i>
        @endauth
    ...
    @auth
        <div
            class="collapse {{ request()->is("admin/consoles*") ? "show" : "" }}"
            id="consolesSubmenu"
        >
            <div class="ps-3">
                <ul class="nav flex-column small">
                    ...
                    <li>
                        <a
                            href="{{ route("admin.consoles.create") }}"
