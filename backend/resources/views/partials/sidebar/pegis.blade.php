...
<li>
    ...
    >
        ...
        @auth
            <i
                class="bi {{ request()->is("admin/pegis*") ? "bi-caret-down-fill" : "bi-caret-right-fill" }}"
            ></i>
        @endauth
    ...
    @auth
        <div
            class="collapse {{ request()->is("admin/pegis*") ? "show" : "" }}"
            id="pegisSubmenu"
        >
            <div class="ps-3">
